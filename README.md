...
✔ Uses the real Windows Explorer.
✔ Portable (~2 MB) andl ightweight (~60 MB RAM).
✔ Restores your workspace after closing or reboot.
✔ The explorer part will update along with Windows itself.
✔ Dark theme, tabs, themes and personalisation, dual-pane browsing, profiles… and more!

## ✨ Key features (quick overview)

### **Tabs done right**
✔ Color and auto-color markers.
...
### **Persistent windows**
✔ Create as many  windows you want, reopen them later exactly as you left them.

### **“Explorer magnet” mode**
✔ Intercept any new Windows Explorer window and it as a new tab without altering any system settings.
...
### **Enhanced path bar**
✔ Breadcrumbs with disk space info.
✔ Classic path text edit with autocomplete and command suppot (like `cmd`).

### **Advanced file selection**
✔ Wildcard-based selection mode (`?` / `*`).
✔ Enhanced selection: Add / Remove files to the current selection.

![Light theme picture](docs/pics/001_white.png)
